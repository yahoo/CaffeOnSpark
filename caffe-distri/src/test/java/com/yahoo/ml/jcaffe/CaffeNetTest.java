...
public class CaffeNetTest {
  ...
  CaffeNet net, test_net, socket_net, socket_net_2;
  ...
  public void setUp() throws Exception {
    ...
    socket_net_2 = new CaffeNet(solver_config_path,
		       "",
		       "",
		       1, //num_local_devices,
		       2, //cluster_size,
  ...
  public void inititerinvalid() {
    ...
    System.out.println("initintervalinvalidtest");
  }
  ...
  @Test
  public void testSocketNet() {
    String[] peer_addrs_1 = socket_net.localAddresses();
    String[] peer_addrs_2 = socket_net_2.localAddresses();
    String[] remote_addrs_for_1 = {peer_addrs_1[0], peer_addrs_2[0]};
    String[] remote_addrs_for_2 = {peer_addrs_1[1], peer_addrs_2[1]};
    assertTrue(socket_net.connect(remote_addrs_for_1));
    assertTrue(socket_net_2.connect(remote_addrs_for_2));
