...
#ifndef CAFFE_DISTRI_RDMA_SYNC_HPP_
#define CAFFE_DISTRI_RDMA_SYNC_HPP_
...
class RDMASync : public P2PSync<Dtype> {
 public:
 ...
 protected:
  ...
  vector<shared_ptr<RDMAChannel> > peers_;
  ...
  vector<shared_ptr<RDMABuffer> > data_send_;
...
DISABLE_COPY_AND_ASSIGN(RDMASync);
};
