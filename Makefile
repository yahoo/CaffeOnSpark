screwdriver: update build package

HOME ?=/home/${USER}
CAFFE_ON_SPARK ?=$(shell pwd)
LD_LIBRARY_PATH=${CAFFE_ON_SPARK}/caffe-public/distribute/lib:${CAFFE_ON_SPARK}/caffe-distri/distribute/lib:/usr/lib64:/lib64 
DYLD_LIBRARY_PATH=${CAFFE_ON_SPARK}/caffe-public/distribute/lib:${CAFFE_ON_SPARK}/caffe-distri/distribute/lib:/usr/lib64:/lib64

build: 
	cd caffe-public; make proto; make -j4 -e distribute; cd ..
	export LD_LIBRARY_PATH="${LD_LIBRARY_PATH}"; mvn -B package -DskipTests
	...
	export LD_LIBRARY_PATH="${LD_LIBRARY_PATH}"; mvn -B package
...
buildosx:
	cd caffe-public; make proto; make -j4 -e distribute; cd ..
	export DYLD_LIBRARY_PATH="${DYLD_LIBRARY_PATH}"; mvn -B package -DskipTests
	...
	export LD_LIBRARY_PATH="${DYLD_LIBRARY_PATH}"; mvn -B package
	cd ${CAFFE_ON_SPARK}/caffe-grid/src/main/python/; zip -r caffeonsparkpythonapi *; mv caffeonsparkpythonapi.zip ${CAFFE_ON_SPARK}/caffe-grid/target/; cd ${CAFFE_ON_SPARK}
update:
	git submodule init
